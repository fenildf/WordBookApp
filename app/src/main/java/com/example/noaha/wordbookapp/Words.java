...
public class Words {
    ...
    public static final String AUTHORITY = "com.example.noaha.wordsprovider";//URI授权者
    ...
    public static abstract class Word implements BaseColumns {
        ...
        public static final String MINE_ITEM = "vnd.noaha.word";
